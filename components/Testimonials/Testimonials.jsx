...
export const PrevButton = ({ enabled, onClick }) => (
  <button
    className="absolute items-center justify-center w-8 h-8 p-2 bg-gradient-to-tl from-red-400 to-yellow-500 hover:shadow-sm rounded shadow-md -translate-y-1/2 bg-transparent border-0 outline-none cursor-pointer embla__button embla__button--prev z-2 top-1/2 -left-4 md:-left-20"
    onClick={onClick}
    disabled={!enabled}
  >
    <svg
...
export const NextButton = ({ enabled, onClick }) => (
  <button
    className="absolute items-center justify-center w-8 h-8 p-2 -translate-y-1/2 bg-gradient-to-br from-red-400 to-yellow-500 hover:shadow-sm border-0 shadow-md rounded outline-none cursor-pointer embla__button embla__button--next z-2 top-1/2 -right-4 md:-right-20"
    onClick={onClick}
    disabled={!enabled}
  >
    <svg
