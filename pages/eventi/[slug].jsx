...
export default function Events({event, img, css}) {
  ...
  function showTheButton(event) {
    if (event.external_link.link === null) {
      ...
      return (
        <Button>
          <a href={event.external_link.link} className="hover:no-underline">
            Partecipa
          </a>
        </Button>
      )
      ...
      {router.isFallback ? (
        ...
        <>
          ...
          <HeaderBig
            ...
            backgroundImgSrc={
              event.featuredImage && event.featuredImage.node.mediaItemUrl
            }
          />
          <section className="relative w-full bg-gray-100 pb-24 pt-16 text-gray-800">
            <div className="container mx-auto px-4">
              <div className="relative lg:flex lg:flex-row">
                <div className="relative -mt-96 mb-6 flex w-full min-w-0 flex-col break-words bg-white pb-24 shadow-lg">
                  <div className="px-6">
                    ...
                    <div className="mt-12">
                      ...
                      {event.venue && (
                        <div className="mb-2 mt-0 text-center text-sm font-bold uppercase leading-normal text-gray-400">
              ...
              <div className="flex justify-center">
                <Link
                  href="/eventi"
                  className="mt-10 rounded bg-white p-4 text-center uppercase no-underline shadow-lg hover:shadow-sm"
                >
                  Eventi
                </Link>
              </div>
