      ...
      <Layout>
        ...
        <main>
          ...
          <section className="relative block pb-20">
            <div className="mx-10vw mb-24 lg:mb-48">
              <Grid featured>
                ...
                <div className="col-span-full lg:col-span-5 lg:col-start-8 lg:mr-12">
                  <Paragraph>
                    ...
                    <strong>Vetrina del Mercato Elettronico</strong> o navigando
                    sul catalogo prodotti, le Amministrazioni possono verificare
                    l’offerta di beni e/o servizi e, una volta abilitate,
                    effettuare acquisti on line, confrontando le proposte dei
                    diversi fornitori e scegliendo più rispondente alle proprie
                    esigenze.
                  </Paragraph>
                </div>
              </Grid>
